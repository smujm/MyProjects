...
import urllib.req uest, urllib.parse, urllib.error
import requests
...
url = 'https://sou.pptv.com/s_video?kw=%E5%8A%A0%E8%8F%B2%E7%8C%AB&pn=1'
...
for i in range(2, 7):
        ...
        try:
            ...
            intro = ''
        try:
            pop = s.xpath('/html/body/div[3]/div[1]/div[{}'.format(i) + ']/div/dl/dd[4]/text()')[0]
        except Exception as e:
            pop = ''
        try:
    ...
    if i != 4:
        ...
        try:
            if i == 6 or i == 7 or i ==8:
                time = s.xpath('/html/body/div[3]/div[1]/div[8]/ul/li[{}'.format(i) + ']/div/p[1]/text()')[0]
            else:
                time = s.xpath('/html/body/div[3]/div[1]/div[8]/ul/li[{}'.format(i) + ']/div/p[1]/span[2]/text()')[0]
        except Exception as e:
            time = ''
        try:
            author = s.xpath('/html/body/div[3]/div[1]/div[8]/ul/li[{}'.format(i) + ']/div/p[1]/a/text()')[0]
        except Exception as e:
            author = ''
        try:
